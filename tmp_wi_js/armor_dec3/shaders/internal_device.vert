...
void main()
{
    ...
    v_viewDistance = (-pos.z - u_depthConstants.x) / u_depthConstants.y;

    v_screenCoord = positionProjected.xyw;
    v_screenCoord.xy = v_screenCoord.xy * 0.5 + vec2(0.5, 0.5) * v_screenCoord.z;
}