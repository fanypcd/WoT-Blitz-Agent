...
{
    vec4 tmp;
    tmp.x = dot(vec4(a_position, 1.0), u_matrixPalette[matrixIndex]);
    tmp.y = dot(vec4(a_position, 1.0), u_matrixPalette[matrixIndex + 1]);
    tmp.z = dot(vec4(a_position, 1.0), u_matrixPalette[matrixIndex + 2]);
    tmp.w = 1.0;
